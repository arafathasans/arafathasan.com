...
function generatePDF() {
  ...
  // Set A4 size dimensions (approximate dimensions in points)
  const pdfWidth = 595.28; // points
  const pdfHeight = 841.89; // points

  // Add content to the PDF document
  doc.setFontSize(16);
  doc.text(`Full Name: ${firstName} ${lastName}`, 20, 30);
  // ... and other form fields
